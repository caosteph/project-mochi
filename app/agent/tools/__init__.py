...
# On the 8k-context model all of them bind and fire 3/3 (measured at 17 tools; the set has grown
# since and still fits). Per-turn selection is kept because it's cheaper (~665 fewer prompt
# tokens/turn), not because a wall forces it.
ALL_TOOLS = [
