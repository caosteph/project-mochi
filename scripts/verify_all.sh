...
for s in verify_phase1 verify_phase2 verify_phase3 verify_phase3b verify_phase4a verify_phase4b verify_dynamic_tools verify_web_search verify_scenarios verify_multiturn; do
