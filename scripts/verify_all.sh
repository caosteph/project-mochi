...
run uv run python scripts/audit_session_scope.py app
run uv run python scripts/check_docs.py
run uv run pytest tests/ -q
for s in verify_phase1 verify_phase2 verify_phase3 verify_phase3b verify_phase4a verify_phase4b verify_dynamic_tools verify_web_search verify_scenarios verify_multiturn verify_builder; do
